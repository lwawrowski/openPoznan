...
Tram_list_with_stops_name_non <- subset(Tram_list_with_stops_name, select = -c(n))

Exp_test <- expand.grid(unique(Tram_list_with_stops_name_non))

Exp_test2 <- expand.grid(Tram_list_with_stops_name_non)
