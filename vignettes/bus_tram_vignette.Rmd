...
colnames(Group_by_stop_trams)[which(names(Group_by_stop_trams) == "n")]  <- "Liczba_tramwajow"
...
colnames(Group_by_stop_bus)[which(names(Group_by_stop_bus) == "n")]  <- "Liczba_autobusów"
...
colnames(Similarities_tram_bus)[which(names(Similarities_tram_bus) == "n")]  <- "Liczba_Maszyn"
...
addCircles(lng = ~Longitude, 
           lat = ~Latitude, 
           weight = 1,
           radius = ~sqrt(Similarities_tram_bus$Liczba_Maszyn) * 25,
           popup = paste("Stop Name:", Similarities_tram_bus$Stop_Name, "<br>",
                         "Number of Machines:", Similarities_tram_bus$Liczba_Maszyn, "<br>",
                         "Number of Trams:", Similarities_tram_bus$Liczba_tramwajow, "<br>",
                         "Number of buses", Similarities_tram_bus$Liczba_autobusów))
