...
colnames(Group_by_stop_trams)[which(names(Group_by_stop_trams) == "n")]  <- "Liczba tramwajow"
...
addCircles(lng = ~Longitude, 
           ...
           popup = paste("Stop Name:", Similarities$Stop_Name, "<br>",
                         "Number of Machines:", Similarities$n))
