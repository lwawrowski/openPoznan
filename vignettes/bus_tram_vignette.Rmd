...
Test_1 <- count(bt_tram, Stop_Name, line)
...
Max_for_one_tram <- sum (Test_1$line == i)
...
MyNames <- paste(nameVals, max_numer_of_stops_for_tram$Test_2, sep=" [")
...
myMat[col(myMat) == row(myMat)] <- myMat[col(myMat) == row(myMat)] + max_numer_of_stops_for_tram$Test_2
